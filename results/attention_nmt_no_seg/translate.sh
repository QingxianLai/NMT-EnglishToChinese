...
cd ../..
THEANO_FLAGS=floatX=float32 python -u -m code.model.attention_nmt.simple_translater -n \
    $HOME/Desktop/cNLP/project/NMT-EnglishToChinese/results/attention_nmt_no_seg/model.npz \
    $HOME/Desktop/cNLP/project/NMT-EnglishToChinese/data/zh/no_seg/zh.train.no_seg.tok.pkl \
    $HOME/Desktop/cNLP/project/NMT-EnglishToChinese/data/en/train.en.tok.pkl \
    $HOME/Desktop/cNLP/project/NMT-EnglishToChinese/data/zh/no_seg/zh.test.no_seg.tok \
    $HOME/Desktop/cNLP/project/NMT-EnglishToChinese/results/attention_nmt_no_seg/test.translation.no_seg
